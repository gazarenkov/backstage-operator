...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LocalDbConfig) DeepCopyInto(out *LocalDbConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LocalDbConfig.
func (in *LocalDbConfig) DeepCopy() *LocalDbConfig {
	if in == nil {
		return nil
	}
	out := new(LocalDbConfig)
	in.DeepCopyInto(out)
	return out
}
